...
"[project]/app/utility/utility.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dive-planner-service/BreathingGas.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/utility/utility.ts [app-ssr] (ecmascript)");
;
class BreathingGas {
    name;
    oxygen;
    ...
    static getOptimalDecoGas(depth, settings) {
        ...
        const oxygen = Math.min(100, (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["floorWithThreshold"])(settings.decoPO2Maximum * 100 / atm));
        ...
        const helium = Math.max(0, (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])(100 - oxygen - nitrogen));
    ...
    calcMinDepth() {
        return Math.max(0, (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])(this.diveSettings.pO2Minimum * 1000 / this.oxygen - 10));
    }
    calcMaxDecoDepth() {
...
"[project]/app/utility/formatters.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dive-planner-service/DiveSegment.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dive-planner-service/DiveSegmentFactory.service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$formatters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/utility/formatters.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/DiveSegment.ts [app-ssr] (ecmascript)");
;
;
class DiveSegmentFactoryService {
    ...
    createEndDiveSegment(startTime, depth, gas) {
        ...
        const ascentTimeDuration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$formatters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanDuration"])(ascentTime);
        const endTime = startTime + ascentTime;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSegment"](startTime, endTime, 'Surface', `Ascent time: ${ascentTimeDuration} @ ${this.settings.ascentRate}m/min`, depth, 0, gas, 'done', this.settings);
    }
    createStartDiveSegment(gas) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSegment"](0, 0, 'Start Dive', gas.description, 0, 0, gas, 'scuba_diving', this.settings);
    }
    createDepthChangeSegment(startTime, previousDepth, newDepth, gas) {
        ...
        const description = newDepth > previousDepth ? `Descent time: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$formatters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanDuration"])(travelTime)} @ ${this.settings.descentRate}m/min` : `Ascent time: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$formatters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanDuration"])(travelTime)} @ ${this.settings.ascentRate}m/min`;
        const icon = newDepth > previousDepth ? 'arrow_downward' : 'arrow_upward';
        return new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSegment"](startTime, endTime, title, description, previousDepth, newDepth, gas, icon, this.settings);
    }
    createGasChangeSegment(startTime, newGas, depth) {
        const title = 'Switch Gas';
        const description = newGas.description;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSegment"](startTime, startTime, title, description, depth, depth, newGas, 'air', this.settings);
    }
    createMaintainDepthSegment(startTime, depth, duration, gas) {
        const endTime = startTime + duration;
        const title = `Maintain Depth at ${depth}m`;
        const description = `Time: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$formatters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanDuration"])(duration)}`;
        const icon = 'arrow_forward';
        return new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSegment"](startTime, endTime, title, description, depth, depth, gas, icon, this.settings);
    }
...
"[project]/app/dive-planner-service/Tissue.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class Tissue {
    ...
    getTimeToInstantCeiling(depth, gas) {
        ...
        while(minNDL < maxNDL){
            ...
            time = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])((maxNDL - minNDL) / 2) + minNDL;
        }
...
"[project]/app/dive-planner-service/BuhlmannZHL16C.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/Tissue.ts [app-ssr] (ecmascript)");
;
class BuhlmannZHL16C {
    tissues = [];
    constructor(){
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](1, 5, 1.1696, 0.5578, 1.51, 1.7474, 0.4245));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](2, 8, 1.0, 0.6514, 3.02, 1.383, 0.5747));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](3, 12.5, 0.8618, 0.7222, 4.72, 1.1919, 0.6257));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](4, 18.5, 0.7562, 0.7825, 6.99, 1.0458, 0.7223));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](5, 27, 0.62, 0.8126, 10.21, 0.922, 0.7582));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](6, 38.3, 0.5043, 0.8434, 14.48, 0.8205, 0.7957));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](7, 54.3, 0.441, 0.8693, 20.53, 0.7305, 0.8279));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](8, 77, 0.4, 0.891, 29.11, 0.6502, 0.8553));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](9, 109, 0.375, 0.9092, 41.2, 0.595, 0.8757));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](10, 146, 0.35, 0.9222, 55.19, 0.5545, 0.8903));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](11, 187, 0.3295, 0.9319, 70.69, 0.5333, 0.8997));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](12, 239, 0.3065, 0.9403, 90.34, 0.5189, 0.9073));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](13, 305, 0.2835, 0.9477, 115.29, 0.5181, 0.9122));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](14, 390, 0.261, 0.9544, 147.42, 0.5176, 0.9171));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](15, 498, 0.248, 0.9602, 188.24, 0.5172, 0.9217));
        this.tissues.push(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$Tissue$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tissue"](16, 635, 0.2327, 0.9653, 240.03, 0.5119, 0.9267));
    }
    clone() {
...
"[project]/app/dive-planner-service/DiveProfile.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/utility/utility.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$BuhlmannZHL16C$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/BuhlmannZHL16C.ts [app-ssr] (ecmascript)");
;
;
class DiveProfile {
    diveSettings;
    ...
    constructor(diveSettings, diveSegmentFactory){
        ...
        this.segments = [];
        this.algo = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$BuhlmannZHL16C$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BuhlmannZHL16C"]();
        this.MAX_NDL = 3600 * 5;
    }
    ...
    getCurrentInstantCeiling() {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])(this.algo.getInstantCeiling(currentTime));
    }
    getCurrentCeiling() {
        ...
        for(let t = this.getPreviousSegment().EndTimestamp; t <= this.getTotalTime(); t++){
            ...
            if (depth < ceiling) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])(this.getDepth(t - 1));
            }
        }
        return 0;
    }
    ...
    getNewInstantCeiling(newDepth, timeAtDepth) {
        const wipProfile = this.getWipProfile(newDepth, this.getPreviousSegment().Gas, timeAtDepth);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])(wipProfile.algo.getInstantCeiling(wipProfile.getTotalTime()));
    }
    getNoDecoLimit(newDepth, newGas, timeAtDepth) {
        ...
        maxTime--;
        let time = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])((maxTime - minTime) / 2) + minTime;
        wipProfile.shortenLastSegment(maxTime + 1 - time);
        while(minTime < maxTime){
            if (wipProfile.canSurfaceWithoutStops()) {
                minTime = time;
                time = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utility$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ceilingWithThreshold"])((maxTime - minTime) / 2) + minTime;
...
"[project]/app/dive-planner-service/ChartGenerator.service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dive-planner-service/DivePlannerService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$BreathingGas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/BreathingGas.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegmentFactory$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/DiveSegmentFactory.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveProfile$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/DiveProfile.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$ChartGenerator$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/ChartGenerator.service.ts [app-ssr] (ecmascript)");
;
;
;
;
class DivePlannerService {
    ...
    constructor(settings){
        ...
        this.diveSegmentFactory = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSegmentFactory$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSegmentFactoryService"](settings);
        this.chartGenerator = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$ChartGenerator$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChartGeneratorService"](this.diveSegmentFactory, settings);
        this.diveProfile = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveProfile$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveProfile"](settings, this.diveSegmentFactory);
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$BreathingGas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BreathingGas"].GenerateStandardGases(settings);
    }
    getStandardGases() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$BreathingGas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BreathingGas"].StandardGases;
    }
    startDive(startGas) {
        this.diveProfile = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveProfile$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveProfile"](this.settings, this.diveSegmentFactory);
    ...
    getOptimalDecoGas(depth) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$BreathingGas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BreathingGas"].getOptimalDecoGas(depth, this.settings);
    }
    getCurrentCeiling() {
...
"[project]/app/dive-planner-service/DiveSettings.service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/contexts/DivePlannerContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DivePlannerService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/DivePlannerService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSettings$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dive-planner-service/DiveSettings.service.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
;
const DivePlannerContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function DivePlannerProvider({ children }) {
    ...
    const divePlanner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const settings = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DiveSettings$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DiveSettingsService"]();
        return new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dive$2d$planner$2d$service$2f$DivePlannerService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DivePlannerService"](settings);
    }, []);
    const forceUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DivePlannerContext.Provider, {
        value: value,
        children: children
    }, void 0, false, {
...
function useDivePlanner() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(DivePlannerContext);
...
function useStartDive() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((startGas)=>{
...
function useAddChangeDepthSegment() {
    const { divePlanner, forceUpdate } = useDivePlanner();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((newDepth)=>{
...
function useAddChangeGasSegment() {
    const { divePlanner, forceUpdate } = useDivePlanner();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((newGas)=>{
...
function useAddMaintainDepthSegment() {
    const { divePlanner, forceUpdate } = useDivePlanner();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((timeAtDepth)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$colors$2f$indigo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__indigo$3e$__ = __turbopack_context__.i("[project]/node_modules/@mui/material/esm/colors/indigo.js [app-ssr] (ecmascript) <export default as indigo>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$colors$2f$purple$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__purple$3e$__ = __turbopack_context__.i("[project]/node_modules/@mui/material/esm/colors/purple.js [app-ssr] (ecmascript) <export default as purple>");
...
const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$styles$2f$createTheme$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__createTheme$3e$__["createTheme"])({
    palette: {
        primary: {
            main: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$colors$2f$indigo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__indigo$3e$__["indigo"][500]
        },
        secondary: {
            main: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$colors$2f$purple$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__purple$3e$__["purple"]['A200']
        },
        error: {
            main: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$colors$2f$red$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__red$3e$__["red"][500]
        },
        warning: {
            main: '#FFC107'
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$contexts$2f$DivePlannerContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/contexts/DivePlannerContext.tsx [app-ssr] (ecmascript)");
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$styles$2f$ThemeProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ThemeProvider$3e$__["ThemeProvider"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$contexts$2f$DivePlannerContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DivePlannerProvider"], {
                children: children
            }, void 0, false, {
                fileName: "[project]/app/providers.tsx",
                lineNumber: 12,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__174ff35d._.js.map